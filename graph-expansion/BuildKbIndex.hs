...
--                     anchorNames :: [T.Text]
--                     anchorNames = fromMaybe mempty $ pagemetaInlinkAnchors $ kbDocMetadata $ doc
--                     disambiguationNames :: [PageName]
--                     disambiguationNames =  fromMaybe mempty $ pagemetaDisambiguationNames $ kbDocMetadata $ doc
--                     inlinkPagenames :: [PageName]
--                     inlinkPagenames =  catMaybes $ fmap pageNameResolver $ fromMaybe mempty $ pagemetaInlinkIds $ kbDocMetadata $ doc
--
--
--             Index.buildTermFreq outputPath
...
--                     disambiguationNames = map getPageName $ fromMaybe mempty $ pagemetaDisambiguationNames $ kbDocMetadata $ doc
--
-- --                     inlinks = fromMaybe mempty
